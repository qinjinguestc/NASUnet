...
class Network(object):
    ...
    def _init_configure(self):
        ...
        parser.add_argument('--config',nargs='?',type=str,default='../configs/nas_unet/nas_unet_BRATS2015.yml',
    ...
    def _init_dataset(self):
        ...
        trainset = get_dataset(self.cfg['data']['dataset'])
        # valset = get_dataset(self.cfg['data']['dataset'], split='val', mode ='val')
        valset = get_dataset(self.cfg['data']['dataset'])
